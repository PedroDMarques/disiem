...
def parseArgs():
	...
	parser.add_argument("mode", 
		choices=["parse", "send", "send-parsed", "parse-send", "send-parse", "rank-parsed", "list", "impossible-timestamps", "noop", "config-write", "config-list", "reset-elasticsearch", "output", "create-index", "delete-index"]
	)
