...
def parseArgs():
	...
	parser.add_argument("mode", 
		choices=["parse", "send", "parse-send", "send-parse", "list", "impossible-timestamps", "noop", "config-write", "config-list", "reset-elasticsearch", "output", "create-index", "delete-index"]
	)
